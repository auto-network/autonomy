...
def resolve_first_org_slug(slug: str | None = None) -> str | None:
    ...
    None means no shared org was named, and none is created: the operator
    creates or joins an organization in onboarding, or has none.
    """
...
def ensure_bootstrap_orgs(
    *,
    ...
    before first launch. Named none, none is created: the operator creates
    or joins an organization in onboarding, or has none. There is no default
    first organization.
