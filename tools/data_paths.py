...
STORE_MANIFEST: tuple = (
    ...
    Store("web_push", "web-push.db", "WEB_PUSH_DB", "db",
          "Web Push subscriptions and bounded transport outbox (never inbox truth)"),
    ...
    Store("web_push_vapid", "web-push-vapid.pem", "WEB_PUSH_VAPID_KEY", "file",
          "mode-0600 stable VAPID sender key for Dashboard Web Push"),
