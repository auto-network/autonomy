"""Machine-wide Agent Test admission control acceptance tests."""
...
def test_machine_store_enforces_cross_container_resource_capacity(tmp_path, monkeypatch):
    ...
    browser_waiter = agent_test_leases.transact("acquire", {
        ...
        "organization": "beta",
        "repository": "github.test/other/widget",
        "selectors": ["tests/test_browser.py"],
        "selector_count": 1,
    })
    ...
    assert status["queued_requests"] == 2
    ...
    assert expired["queued_requests"] == 0
