...
WebCrypto when an organization sign-on or password-backed dashboard unlock
finds that repair is required. This runs that REAL function in Node
...
@pytest.mark.parametrize("mode", ["explicit", "signon", "repair"])
