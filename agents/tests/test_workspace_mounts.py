...
# ── blocker 6: rev-1 rows drop on the actual load path (no 1->2 upconverter) ──
def test_load_mounts_drops_rev1_rows(graph_db_env):
    ops.add_setting(
    ...
    assert set(mounts) == {"w:new"}   # the rev-1 row dropped, not upconverted
