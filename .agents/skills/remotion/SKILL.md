---
name: remotion
description: Create keyframe-animated videos and animated diagrams with Remotion (React video compositions rendered to MP4/WebM). Use for animated explainers, scene-based walkthroughs, ceremony/workflow animations, or any "animated presentation" request. Router to the full Remotion skill suite (create, markup, render, studio, transitions, maps, captions).
version: 4.0.518
---

<!-- Vendored from remotion-dev/skills v4.0.518 (npx skills add remotion-dev/skills),
     2026-08-28, session auto-0827-232652. Self-contained: sub-skill references below
     resolve to the nested remotion-*/ directories in this folder.
     To refresh: run `npx skills add remotion-dev/skills` in a scratch dir and copy
     .agents/skills/remotion-best-practices/ over this directory (keep this frontmatter). -->
